...
var (
	...
	reduceJobs = flag.Int("reducejobs", 2, "Number of reduce jobs that should be run")
	chunkSize  = flag.Int("chunksize", 1*1024, "Size of data chunks that should be passed to map jobs(in bytes)")
)
